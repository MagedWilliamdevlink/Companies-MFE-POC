...
export default function Footer() {
  return (
    <footer className="bg-[#262B33] border-t border-gray-200 text-[#FFFFFF] mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8" dir="rtl">
          ...
          <div>
            ...
            <p className=" leading-relaxed">
              منصة متكاملة تقدم جميع الخدمات الحكومية الإلكترونية بسهولة وأمان
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-center gap-2">
                ...
                <span className="text-white">19000 - الخط الساخن</span>
              </li>
              <li className="flex items-center gap-2">
                <svg
                  className="w-5 h-5 text-[#6E7786]"
                ...
                <span className="text-white">info@mcit.gov.eg</span>
              </li>
              <li className="flex items-center gap-2">
                <svg
                  className="w-5 h-5 text-[#6E7786]"
